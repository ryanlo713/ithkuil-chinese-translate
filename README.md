...
作为最後一个说明Ithkuil的词汇语义学的潜力和简明性的例子，思考以下词语：湿透、潮湿、湿、微湿、半乾、乾、乾涸、焦乾。Ithkuil认识到这些词都表示含水量在一个连续范围内的相对程度，因此，这种连续统一体会表示为用一个大概表示【湿度】的词根，加上一个後缀以说明在一个连续范围内的各种潮湿程度。所有这些一般语言常常在语义上划分为二元反义词（如长——短、硬——软、明——暗、浅——深等）的现象，在Ithkuil里都被认为是同一性质的现象並词汇化为单一的词根，然後用一个阵列式的後缀来系统地阐明其在一个连续范围内的具体程度。
